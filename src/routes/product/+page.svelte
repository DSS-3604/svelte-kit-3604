<script lang="ts">
	...
	import { Card, Rating, RatingComment, Avatar, Button, Badge, Modal, Img } from 'flowbite-svelte';
...
<div class="m-5">
	<div class="p-4">
		<div class="flex flex-col items-center pb-4">
			<Img src="https://i0.wp.com/post.medicalnewstoday.com/wp-content/uploads/sites/3/2022/07/what_to_know_apples_green_red_1296x728_header-1024x575.jpg?w=1155&h=1528" alt="Product" size="max-w-xl"  class="shadow-xl dark:shadow-gray-800" />
