...
<div class="p-5">
	...
	<!-- <div class="flex flex-wrap mt-6 -mx-3">
					...
					<div class="flex flex-wrap -mx-3">
						<div class="max-w-full px-3 lg:w-1/2 lg:flex-none">
							<div class="flex flex-col h-full">
								...
								<a
									class="mt-auto mb-0 font-semibold leading-normal text-size-sm group text-slate-500"
								>
									Read More
									<i
										class="fas fa-arrow-right ease-bounce text-size-sm group-hover:translate-x-1.25 ml-1 leading-normal transition-all duration-200"
									/>
								</a>
							</div>
						</div>
		...
		<div class="w-full max-w-full px-3 lg:w-5/12 lg:flex-none">
			...
			>
				...
				>
					<span
						class="absolute top-0 left-0 w-full h-full bg-center bg-cover bg-gradient-dark-gray opacity-80"
					/>
					<div class="relative z-10 flex flex-col flex-auto h-full p-4">
						...
						<a
							class="mt-auto mb-0 font-semibold leading-normal text-white group text-size-sm"
							href="javascript:;"
						>
							Read More
							<i
		...
		<div class="w-full max-w-full px-3 mt-0 mb-6 lg:mb-0 lg:w-5/12 lg:flex-none">
			...
			>
				<div class="flex-auto p-4">
					...
					<p class="ml-2 leading-normal text-size-sm">
	...
	<div class="flex flex-wrap my-6 -mx-3 ">
		...
		<div
			class="dark:bg-gray-900 rounded-2xl w-full max-w-full px-3 mt-0 mb-6 md:mb-0 md:w-1/2 md:flex-none lg:w-2/3 lg:flex-none"
		>
			<div
										...
										<td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
											<div class="flex px-2 gap-2 py-1">
												<div class="w-2/5 sm:w-full">
													<img
														src={avatar}
														class="h-9 w-9 items-kjcenter justify-center mr-4 text-white transition-all duration-200 ease-soft-in-out text-size-sm  rounded-xl"
														alt="xd"
													/>
												</div>
												<div class="flex flex-col justify-center w-3/5 sm:w-full">
													<h6 class="mb-0 leading-normal text-size-sm">Soft UI X</h6>
												</div>
											</div>
										</td>
										<td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
											<div class="mt-2 avatar-group">
												...
												>
													<img src={avatar} class="w-full rounded-full" alt="team1" />
												</a>
												<div
													data-target="tooltip"
												...
												{#each [1, 2, 3] as item}
													<a
														...
														data-placement="bottom"
													>
														<img src={avatar} class="w-full rounded-full" alt="team2" />
													</a>
													<div
														data-target="tooltip"
														class="hidden px-2 py-1 text-white bg-black rounded-lg text-size-sm"
